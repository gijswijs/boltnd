...
func ReplyMessageTestCase(ht *lntest.HarnessTest) {
	...
	// Alice -> Bob
	openChannelAndAnnounce(ht, ht.Alice, ht.Bob, carol, dave)

	// Bob -> Carol
	openChannelAndAnnounce(ht, ht.Bob, carol, ht.Alice, dave)

	// Carol -> Dave
	fundNode(ctxb, ht, carol)
	openChannelAndAnnounce(ht, carol, dave, ht.Alice, ht.Bob)
